...
\usepackage[hmargin=0.5in,vmargin=0.5in]{geometry}                  % the 'contemporary' style looks better with reduced margins; uncomment the line below for increased margin
...
% \address{35 Olden Street}{Princeton, NJ 08540}{United States}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
\phone[mobile]{+1~(609)~240~5334}                   % optional, remove / comment the line if not wanted; the optional "type" of the phone can be "mobile" (default), "fixed" or "fax"
% \phone[fixed]{+2~(345)~678~901}
% \phone[fax]{+3~(456)~789~012}
\email{tb21@princeton.edu}                               % optional, remove / comment the line if not wanted
\homepage{tanushreebanerjee.github.io}                         % optional, remove / comment the line if not wanted

% Social icons
\social[linkedin]{tanushreebanerjee1}                        % optional, remove / comment the line if not wanted
...
\social[googlescholar]{9gamKaAAAAAJ}            % optional, remove / comment the line if not wanted
